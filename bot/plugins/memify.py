...
async def handler(event):
    ...
    if not event.reply_to_msg_id:
        return await event.reply("Reply to an image or a sticker for me to create its memified version.")
    ...
    try:
        ...
        await event.reply("Something wrong happened, perhaps you are trying on animated sticker?")
...
async def drawText(image_path, text):
    ...
    fnt = "bot/assets/Roboto-Medium.ttf"
